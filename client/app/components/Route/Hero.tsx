...
const Hero: FC<Props> = (props) => {
  ...
  const data ={layout:{banner:{image:{url:img1.src},title:"Learn from the best teachers",subTitle:"Join our platform and get access to the best courses from top instructors"}}}
  // sample end here
